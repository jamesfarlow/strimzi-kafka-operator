...
public class ResourceOperatorSupplier {
    ...
    private ResourceOperatorSupplier(Vertx vertx,
        ...
        this(new ServiceOperator(vertx, client, useServerSideApply),
                pfa.hasRoutes() ? new RouteOperator(vertx, client.adapt(OpenShiftClient.class), useServerSideApply) : null,
                pfa.hasImages() ? new ImageStreamOperator(vertx, client.adapt(OpenShiftClient.class), useServerSideApply) : null,
                new StatefulSetOperator(vertx, client, operationTimeoutMs, useServerSideApply),
                new ConfigMapOperator(vertx, client, useServerSideApply),
                new SecretOperator(vertx, client, useServerSideApply),
                new PvcOperator(vertx, client, useServerSideApply),
                new DeploymentOperator(vertx, client, useServerSideApply),
                new ServiceAccountOperator(vertx, client, useServerSideApply),
                new RoleBindingOperator(vertx, client, useServerSideApply),
                new RoleOperator(vertx, client, useServerSideApply),
                new ClusterRoleBindingOperator(vertx, client, useServerSideApply),
                new NetworkPolicyOperator(vertx, client, useServerSideApply),
                new PodDisruptionBudgetOperator(vertx, client, useServerSideApply),
                new PodOperator(vertx, client, useServerSideApply),
                new IngressOperator(vertx, client, useServerSideApply),
                pfa.hasBuilds() ? new BuildConfigOperator(vertx, client.adapt(OpenShiftClient.class), useServerSideApply) : null,
                pfa.hasBuilds() ? new BuildOperator(vertx, client.adapt(OpenShiftClient.class), useServerSideApply) : null,
                new CrdOperator<>(vertx, client, Kafka.class, KafkaList.class, Kafka.RESOURCE_KIND, useServerSideApply),
                new CrdOperator<>(vertx, client, KafkaConnect.class, KafkaConnectList.class, KafkaConnect.RESOURCE_KIND, useServerSideApply),
                ...
                new CrdOperator<>(vertx, client, KafkaRebalance.class, KafkaRebalanceList.class, KafkaRebalance.RESOURCE_KIND, useServerSideApply),
                new CrdOperator<>(vertx, client, KafkaNodePool.class, KafkaNodePoolList.class, KafkaNodePool.RESOURCE_KIND, useServerSideApply),
                new StrimziPodSetOperator(vertx, client, useServerSideApply),
                new StorageClassOperator(vertx, client, useServerSideApply),
                new NodeOperator(vertx, client, useServerSideApply),
                zkScalerProvider,
                metricsProvider,
                adminClientProvider,
                zlf,
